...
нашего исследования  основаны на конусах устойчивости, введенных в главе
\ref{chapter1} диссертации (см. также~\cite{Khokhlova&Kipnis&Malygina_2011}), но требуют изменения в связи с спецификой задачи о неограниченности  количестве нейронов в кольце.
...
\end{equation}
где $n\times n$ матрицы $A,B$ одновременно триангулируемы.  В главе \ref{chapter1} и статье автора диссертации 
