...
кривой~\eqref{curvemain1} множество. Поэтому  вопрос об устойчивости системы ~\eqref{matrixP},~\eqref{mainmatrix1} сводится к
геометрической проблеме. Если все точки кривой~\eqref{curvemain1} лежат внутри
конуса устойчивости~\eqref{cone},~\eqref{preimage} (см.~определение~\ref{defin_cone}), то система~\eqref{matrixP},
