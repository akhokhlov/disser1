...
Теоремы~\ref{th:stab_with_great_n} (см. также ССЫЛКА СМО Таня).
...
с помощью программного продукта <<Устойчивость  нейронных сетей>>.
...
На рисунке представлены области и неустойчивости системы~\eqref{eq_gamma} при
различных значениях коэффициента~$\gamma$.
...
Аналогично исследуются области устойчивости и неустойчивости системы
~\eqref{matrixP}, \eqref{mainmatrix2} при введении некоторого не
равного единице коэффициента~$\gamma$ при~$x_{j}(t)$.
